...
export default function Home() {
  return (
    ...
    >
      ...
      >
        Naša domaća jaja dolaze sa porodične farme iz slobodnog uzgoja, gde koke
        uživaju u prirodnom okruženju. Svako jaje je pažljivo sakupljeno kako bi
        do vašeg stola stiglo sveže i puno ukusa.
      </h5>
